...
def build_inference_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--vit_layers",
        type=str,
        default=DEFAULT_VIT_LAYERS,
        help='Layers to use, e.g. "11,11,11" or "2,5,8,11"',
    )

    parser.add_argument(
        "--decoder_up_factor", type=int, default=DEFAULT_DECODER_UP_FACTOR
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=CROP_D,
        help="Depth chunk size for the sliding window over Z.",
    )
